...
class BloodB_DB {
    ...
    static String UserQuery() {
        ...
        if (val == 2) {
            System.out
                    .println("press 1 to see the list of receipient who are older than or younger than a specific age");
            System.out.println("press 2 to see the list of receipient with a specific blood group");
            int var = scan.nextInt();
            if (var == 1) {
                System.out.println("for older than a specific age enter 1");
                System.out.println("for younger than a specific age enter 2");
                ...
                if (temp == 1) {
                    System.out.println("enter the age");
                    int age = scan.nextInt();
                    query = "select * from receipient where age > " + age;
                }
                if (temp == 2) {
                    System.out.println("enter the age");
                    int age = scan.nextInt();
            ...
            if (var == 2) {
                ...
                scan.nextLine();
                String temp = scan.nextLine();
                query = "select * from receipient where blood_group = \"" + temp + "\"";
            }
        }
        if (val == 3) {
